...
if nav == "Data Exploration":
  ...
  col1.metric("Min", all_data[choice_data_exp].min())
  col2.metric("q1", all_data[choice_data_exp].quantile(q=0.25))
  col3.metric("Average", all_data[choice_data_exp].mean())
  col4.metric("q3", all_data[choice_data_exp].quantile(q=0.75))
  col5.metric("Max", all_data[choice_data_exp].max())
